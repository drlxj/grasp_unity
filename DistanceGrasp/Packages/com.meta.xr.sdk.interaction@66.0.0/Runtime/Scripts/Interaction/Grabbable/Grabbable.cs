...
namespace Oculus.Interaction
{
    ...
    {
        /// <summary>
        /// A One-hand Grab...Transformer component, which should be attached to the grabbable object. Defaults to One Grab Free Transformer.
        ...
        /// <summary>
        /// A Two-hand Grab...Transformer component, which should be attached to the grabbable object.
        ...
        public override void ProcessPointerEvent(PointerEvent evt)
        {
            ...
            switch (evt.Type)
            {
                ...
                case PointerEventType.Move:
                    Vector3 tmp = this.GetComponent<DistanceHandGrabInteractable>().ObjectOffset;
                    UpdateTransform(tmp);
                    break;
            }
        }
        ...
        private void UpdateTransform(Vector3 tmp)
        {
            if (_activeTransformer == null)
            {
                return;
            ...
            // (_activeTransformer as GrabFreeTransformer).UpdateTransform(tmp);
        }
