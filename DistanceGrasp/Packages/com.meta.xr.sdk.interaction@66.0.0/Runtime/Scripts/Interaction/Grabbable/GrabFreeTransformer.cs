...
namespace Oculus.Interaction
{
    ...
    public class GrabFreeTransformer : MonoBehaviour, ITransformer
    {
        ...
        /*
         *  NOTE:
         *  Update the object's movement here.
         */
        public void UpdateTransform()
        {
            ...
            // Use the centroid as the target position
            ...
            // Ensure the object's position is within certain bounds
            ...
            // Debug.Log($"Original Location: {tmp},   Target Location:    + {targetTransform.position}");
            // + new Vector3(0.5f, 0f, 0f)
            // targetTransform.position = new Vector3(3.5f, 0.8f, 0f);
        }

        public void UpdateTransform(Vector3 offset)
        {
            // Debug.Log("Current Offset: " +  offset.ToString());
            int count = _grabbable.GrabPoints.Count;
            Transform targetTransform = _grabbable.Transform;

            // Use the centroid as the target position
            Vector3 localPosition = UpdateTransformerPointData(_grabbable.GrabPoints) + offset;
            ...
            targetTransform.position = TransformerUtils.GetConstrainedTransformPosition(position, _relativePositionConstraints, targetTransform.parent);
            // Debug.Log($"Original Location: {tmp},   Target Location:    + {targetTransform.position}");
            // targetTransform.position = new Vector3(5f, 1.5f, -1.5f);
        }
