...
namespace Oculus.Interaction.Input
{
    ...
    public class LastKnownGoodHand : Hand
    {
        ...
        protected override void Apply(HandDataAsset data)
        {
            ...
            //UnityEngine.Debug.Log("data.IsHighConfidence: " + data.IsHighConfidence.ToString() + ",   IsDataValid: " + data.IsDataValid.ToString() + ",    IsTracked: " + data.IsTracked.ToString() + ",   shouldUseData: " + shouldUseData);
