...
//     {
//         string objectInfoFolderPath = $"../collected_data/s{TestUserId}/{TargetObjectName}/{start_timestamp}/meta_data/";
...
//         string RotationSeqFolderPath = $"../collected_data/s{TestUserId}/{TargetObjectName}/{start_timestamp}/meta_data/";
...
//         string GestureFolderPath = $"../collected_data/s{TestUserId}/{TargetObjectName}/{start_timestamp}/";
...
//     // private void AppendWristPos(int flag)
//     // {
//     //     TelemetryMessage currentMessage = this.GetComponent<MiniDataCollectionTrackData>().currentMessage;
//     //     Vector3 rootPosition = currentMessage.rootPosition;
//     //     string wristPositionInfo = $"{rootPosition.x}|{rootPosition.y}|{rootPosition.z}";
...
//     //     gestureLogAllScores[gestureLogAllScores.Count - 1] += $",{wristPositionInfo}";
//     //     gestureLogAllScores[gestureLogAllScores.Count - 1] += $",{gestureInfo}";
//     //     gestureLogAllScores[gestureLogAllScores.Count - 1] += $",{flag}";
//     //     isGrasping = false;
//     // }
